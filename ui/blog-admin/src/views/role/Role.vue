...
export default {
  ...
  methods: {
    ...
    listRoles() {
      ...
      this.axios.get(`${baseUrl}/admin/role/resources`).then(({ data }) => {
        this.resources = data.data
      })
      this.axios.get(`${baseUrl}/admin/role/menus`).then(({ data }) => {
    ...
    deleteRoles(id) {
      ...
      this.axios.delete(`${baseUrl}/admin/roles`, param).then(({ data }) => {
        if (data.flag) {
          this.$notify.success({
            title: '成功',
    ...
    saveOrUpdateRoleResource() {
      ...
      this.axios.post(`${baseUrl}/admin/role`, this.roleForm).then(({ data }) => {
        if (data.flag) {
          this.$notify.success({
            title: '成功',
            message: data.message
