<template>
  <el-card class="main-card">
    ...
    <div class="operation-container">
      <el-button type="danger" size="small" icon="el-icon-delete" :disabled="this.logIds.length == 0"
        @click="isDelete = true">
        批量删除
      </el-button>
...
export default {
  ...
  methods: {
    ...
    listLogs() {
      this.axios
        .get(`${baseUrl}/admin/operation/logs`, {
          params: {
    ...
    deleteLog(id) {
      ...
      this.axios.delete(`${baseUrl}/admin/operation/logs`, param).then(({ data }) => {
        if (data.flag) {
          this.$notify.success({
            title: '成功',
