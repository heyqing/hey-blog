<template>
  <el-card class="main-card">
    ...
    <div class="operation-container">
      <el-button type="danger" size="small" icon="el-icon-delete" :disabled="logIds.length === 0"
        @click="isDelete = true">
        批量删除
      </el-button>
      <div style="margin-left: auto">
        <el-input v-model="keywords" prefix-icon="el-icon-search" size="small" placeholder="请输入操作描述"
...
export default {
  ...
  methods: {
    ...
    listLogs() {
      this.axios
        .get(`${baseUrl}/admin/exception/logs`, {
          params: {
    ...
    deleteLog(id) {
      ...
      this.axios.delete(`${baseUrl}/admin/exception/logs`, param).then(({ data }) => {
        if (data.flag) {
          this.$notify.success({
            title: '成功',
