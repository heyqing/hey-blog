<template>
  <el-card class="main-card">
    ...
    <div class="operation">
      ...
      <el-button type="success" @click="updatePhotoDelete(null)" :disabled="selectPhotoIds.length == 0" size="small"
...
export default {
  ...
  methods: {
    ...
    deletePhotos() {
      this.axios.delete(`${baseUrl}/admin/photos`, { data: this.selectPhotoIds }).then(({ data }) => {
        if (data.flag) {
          this.$notify.success({
            title: '成功',
            message: data.message
