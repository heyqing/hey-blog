  ...
  <el-card class="main-card">
    ...
    <div class="operation-container">
      <div style="margin-left: auto">
        ...
        <el-input v-model="keywords" prefix-icon="el-icon-search" size="small" placeholder="请输入昵称" style="width: 200px"
...
export default {
  ...
  methods: {
    ...
    changeDisable(user) {
      this.axios.put(`${baseUrl}/admin/users/disable`, {
        id: user.userInfoId,
    ...
    editUserRole() {
      ...
      this.axios.put(`${baseUrl}/admin/users/role`, this.userForm).then(({ data }) => {
        if (data.flag) {
          this.$notify.success({
            title: '成功',
    ...
    listRoles() {
      this.axios.get(`${baseUrl}/admin/users/role`).then(({ data }) => {
