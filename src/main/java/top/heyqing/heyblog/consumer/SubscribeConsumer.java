...
import static top.heyqing.heyblog.constants.RabbitMQConstant.SUBSCRIBE_QUEUE;
    ...
    public void process(byte[] data) {
        ...
        for (String email : emails) {
            ...
            if (article.getUpdateTime() == null) {
                map.put("content", "何以晴的个人博客发布了新的文章，"
                        + "<a style=\"text-decoration:none;color:#12addb\" href=\"" + url + "\">点击查看</a>");
            } else {
                map.put("content", "何以晴的个人博客对《" + article.getArticleTitle() + "》进行了更新，"
                        + "<a style=\"text-decoration:none;color:#12addb\" href=\"" + url + "\">点击查看</a>");
            }
