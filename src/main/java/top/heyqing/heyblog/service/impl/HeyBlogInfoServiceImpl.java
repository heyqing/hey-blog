...
import top.heyqing.heyblog.model.entity.About;
import top.heyqing.heyblog.model.entity.Article;
import top.heyqing.heyblog.model.entity.Comment;
import top.heyqing.heyblog.model.entity.WebsiteConfig;
...
/**
 * ClassName:HeyBlogInfoServiceImpl
 * Package:top.heyqing.heyblog.service.impl
 * Description:
 *
 * @Date:2024/11/30
...
public class HeyBlogInfoServiceImpl implements HeyBlogInfoService {
    ...
    @SneakyThrows
    @Override
    public HeyBlogHomeInfoDTO getHeyBlogHomeInfo() {
        ...
        return HeyBlogHomeInfoDTO.builder()
    ...
    @Override
    public HeyBlogAdminInfoDTO getHeyBlogAdminInfo() {
        Object count = redisService.get(BLOG_VIEWS_COUNT);
        ...
        HeyBlogAdminInfoDTO heyBlogAdminInfoDTO = HeyBlogAdminInfoDTO.builder()
        ...
        if (CollectionUtils.isNotEmpty(articleMap)) {
            ...
            heyBlogAdminInfoDTO.setArticleRankDTOs(articleRankDTOList);
        }
        return heyBlogAdminInfoDTO;
    }
